    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url()?>index.php/purchase">Edit Purchase</a></li>
            </ol>
        </section>
    <br/>
...
<div class="col-md-12 main-mid-area"> 
   ...
   <div class="pull-right"> 
    <a href="<?php echo base_url()?>index.php/purchase/add" class="btn btn-info pull-right" > <i class="fa fa-plus-square gap">  </i> New Purchase</a> 
   </div>
