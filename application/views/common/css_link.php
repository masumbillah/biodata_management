...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Biodata information system</title>
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        <!-- Custom style -->
        <link href="<?php echo base_url(); ?>style_sheet/css/custom-style.css" rel="stylesheet" type="text/css" />
        <!-- bootstrap 3.0.2 -->
        ...
        <script src="<?php echo base_url()?>style_sheet/js/jquery-ui-1.8.18.custom.min.js"></script>
        <script src="<?php echo base_url()?>style_sheet/js/jquery-1.10.2.js"></script>
